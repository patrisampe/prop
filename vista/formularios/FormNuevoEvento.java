 ...
 * @author tabletom
 */
public class FormNuevoEvento extends javax.swing.JDialog {
    ...
    public FormNuevoEvento(VistaEvento vista, String tipo) {
        initComponents();
        this.vista = vista;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Set<String> nomDip = new TreeSet<>();
        for (Integer i = 0; i < jComboBox1.getItemCount(); ++i)
            nomDip.add(jComboBox1.getItemAt(i).toString());
        ctrlEve.addEvento(jTextField2.getText(), jTextField1.getText(), fecha, nomDip);
