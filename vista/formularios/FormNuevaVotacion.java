...
import controladores.ControladorDominioBusquedaPorDiputado;
import controladores.ControladorDominioBusquedaPorPeriodo;
 ...
 * @author tabletom
 */
public class FormNuevaVotacion extends javax.swing.JDialog {
    ...
    public FormNuevaVotacion(VistaVotacion vista) {
        initComponents();
        this.vista = vista;
        VG=new VistaGenerica();
        setLocationRelativeTo(null);
        setModal(true);
        diputados=new TreeMap<>();
     ...
     private void rellenaCamposDiputados() {
        ...
        Set<String> dipteor=CDD.getNombres();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Nueva votación");

        jButton1.setText("Nueva Votacion");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CDV.addVotacion(nom,data,imp,diputados);
        VG.ControlError(CDV);
        vista.rellenaVotacion();
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jComboBox6.getSelectedIndex() >= 0) {
            diputados.put(jComboBox6.getSelectedItem().toString(), TipoVoto.valueOf(jComboBox4.getSelectedItem().toString()));
            rellenaCamposDiputados();
        }
