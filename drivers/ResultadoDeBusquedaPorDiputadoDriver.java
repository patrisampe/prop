...
public class ResultadoDeBusquedaPorDiputadoDriver {
	...
	private static Integer muestraMenuMetodosCons() {
		...
		SC.Write("12.-Consultar lapso de tiempo");
		SC.Write("13.-Consultar criterio");
		return EC.ReadInteger();
	}
	...
	private static void getLapsoDeTiempo() {
		SC.Write("El lapso de tiempo es: " + resultado.getLapsoDetiempo());
	}
	...
	private static void menuMetodosCons() {
		...
		while (a != 0) {
			...
			case 12:getLapsoDeTiempo(); break;
			case 13:getCriterio(); break;
			default: break;
			}
		}
	}
