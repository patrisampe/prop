 ...
 * @author tabletom
 */
public class FormConsultarVotacion extends javax.swing.JDialog {
    ...
    public FormConsultarVotacion(VistaVotacion vista, String nombre) {
        ...
        nombres = new ArrayList<>(CDV.getVotaciones());
    ...
    private void rellenaCampos(String nombre) {
        ...
        jTextField3.setText(CDV.getImportanciaVotacion(nombre).toString());
        jTextField4.setText(CDV.getFechaVotacion(nombre).toString());
        Set<String> dip = CDV.getDiputadosVotacion(nombre);
        jComboBox1.removeAllItems();
        for (String dipu:dip) {
            jComboBox1.addItem(dipu+" , "+CDV.getVotoDiputado(nombre, dipu).toString());
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Consultar Votacion");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FormModificarVotacion form = new FormModificarVotacion(vista, jTextField1.getText());
